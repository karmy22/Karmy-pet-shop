...
function Navbar() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setTickerIndex((current) => (current + 1) % 4);
    }, 5000);
  ...
  const speciesMenus = STORE_SPECIES.map((species) => ({
    key: species.slug,
    label: species.label,
    ...
    links: [
      {
        to: '/faq',
        label: 'FAQ',
        description: 'Answers to the most common shopping and storefront questions.',
      },
      {
        to: '/contact-us',
        label: 'Contact Us',
    ...
    links: [
      {
        ...
        function Navbar() {
          ...
          return (
            <div className="store-nav-shell" onMouseLeave={() => { setActiveMenu(null); setAccountOpen(false); }}>
              <div
              ...
              >
                <div className="store-utility-inner">
                  <button
                    ...
                    onClick={() => setTickerIndex((current) => (current + tickerItems.length - 1) % tickerItems.length)}
                  >
                    &#8249;
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => setTickerIndex((current) => (current + 1) % tickerItems.length)}
                  >
                    &#8250;
                  </button>
                </div>
                      ...
                      >
                        ...
                        {accountOpen && (
                          <div className="store-account-dropdown">
                            ...
                            <Link to="/account/profile">Profile & Shipping</Link>
                      ...
                      <div className="store-mobile-list">
                        {user ? (
                          <>
                            ...
                            <Link to="/account/orders" onClick={() => setMobileOpen(false)}>Order Tracking</Link>
                            <Link to="/account/profile" onClick={() => setMobileOpen(false)}>Profile Settings</Link>
                            <Link to="/forgot-password" onClick={() => setMobileOpen(false)}>Reset Password</Link>
                          ...
                          <>
                            ...
                            <Link to="/forgot-password" onClick={() => setMobileOpen(false)}>Forgot Password</Link>
                          </>
                        )}
                      </div>
                    </section>
